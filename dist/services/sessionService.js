...
exports.deleteSessionService = exports.updateSessionService = exports.getAllSessionService = exports.getSessionService = exports.createSessionService = void 0;
const sessionModel_1 = __importDefault(require("../models/sessionModel"));
const handler_1 = require("../util/handler");
let createSessionService = (sessionData, userObject) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const session = yield sessionModel_1.default.create({ user, title, body, date, time });
...
let getAllSessionService = handler_1.getAll(sessionModel_1.default);
exports.getAllSessionService = getAllSessionService;
